...
//				-> n개의 DAO에서 수행된 SQL 을 한 번에 commit/rollback
...
public class MemberService {
	...
	public int duplicateCheck(String memberId) throws Exception {
		...
		// (SELECT 는 별도의 트랜잭션 제어 필요 없음)
		// 3. 사용한 connection 객체 반환
		close(conn);
		
		
		// 4. 중복 검사 결과 View 로 반환
		return result;
